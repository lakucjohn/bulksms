...
if(isset($_SESSION['user'])) {
    ...
    <head>
        ...
        <style>
            ...
            .sent-sms-color {
                background-color: rgba(118, 215, 196, 0.2);
            }
        </style>
    ...
    <?php include_once 'solid-div-tabs.php'; ?>
            ...
            <section class="details-tab-sec slight-shadow sent-sms-color">
                ...
                <div id="DivCheckTime">
                    ...
                    <table class="tbl-sent-sms">
                        ...
                        <?php
                        if ($sent_messages_run = mysqli_query($conn, $sort_by_time_sql)) {
                            while ($rs = mysqli_fetch_assoc($sent_messages_run)) {
                ...
                <div id="DivCheckRecipient" style="display: none;">
                    ...
                    <table class="tbl-sent-sms">
                        ...
                        <?php
                        if ($sent_messages_run = mysqli_query($conn, $sort_by_recipient_sql)) {
                            while ($rs = mysqli_fetch_assoc($sent_messages_run)) {
                ...
                <div id="DivCheckMessage" style="display: none;">
                    ...
                    <table class="tbl-sent-sms">
                        ...
                        <?php
                        if ($sent_messages_run = mysqli_query($conn, $sort_by_message_sql)) {
                            while ($rs = mysqli_fetch_assoc($sent_messages_run)) {
